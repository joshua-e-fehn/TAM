...
```
@inproceedings{lim2024robustness,
  ...
  number={},
  pages={1-2},
  keywords={Location awareness;Computers;Simultaneous localization and mapping;Computational modeling;Graphics processing units;Filtering algorithms;Benchmark testing;Autonomous Racing;Localization;Particle Filter;Monte Carlo Localization;SLAM;Robustness},
...
@article{baumann2024forzaeth,
  ...
  number = {4},
  pages = {1037-1079},
  keywords = {autonomous driving, autonomous racing, motion control, open source software, path planning, robotic perception, state estimation},
  doi = {https://doi.org/10.1002/rob.22429},
  url = {https://onlinelibrary.wiley.com/doi/abs/10.1002/rob.22429},
  eprint = {https://onlinelibrary.wiley.com/doi/pdf/10.1002/rob.22429},
  year = {2025}
}
```
